...
const menuItems = [
  ...
  { text: "Annoucement", icon: <CampaignIcon />, path: "/announcement" },
];
            ...
            <ListItem key={item.text} disablePadding sx={{ display: "block" }}>
              <Link href={item.path}>
                <ListItemButton
                  ...
                  onClick={() => item.submenu && handleClick(item.text)}
                >
                  <ListItemIcon
                    sx={{
                      minWidth: 0,
              ...
              {item.submenu &&
                (open ? (
                  // Drawer open mode: display submenu items directly
                  ...
                  // Drawer hide mode: collapsible submenu
                  <Collapse
